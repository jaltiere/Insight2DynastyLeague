...
export default function RookieRecords() {
  ...
  const { data, isLoading, error } = useQuery({
    queryKey: ['rookieRecords', view, matchType, rosterType, position],
    queryFn: () =>
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold mb-6">Rookie Records</h1>

      <div className="bg-white rounded-lg shadow mb-6">
        <div className="bg-blue-600 text-white px-6 py-3 rounded-t-lg">
          <h2 className="text-xl font-semibold">Top 10 Rookie Scoring Performances</h2>
        </div>
        ...
        {isLoading ? (
          <div className="p-6">
            <p className="text-gray-600">Loading rookie records...</p>
          </div>
        ) : error ? (
          <div className="p-6">
