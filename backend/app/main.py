...
from app.api.routes import standings, players, owners, matchups, drafts, league_history, sync, player_records, rookie_records, taxi_squads, seasons, transactions, trade_grades, draft_grades, playoffs, power_rankings, matchup_recaps, newsletter, roster_analysis, trade_calculator, draft_picks, team_records, free_agents, search
...
app.include_router(trade_grades.router, prefix="/api", tags=["Trade Grades"])
app.include_router(draft_grades.router, prefix="/api", tags=["Draft Grades"])
app.include_router(playoffs.router, prefix="/api", tags=["Playoffs"])
app.include_router(power_rankings.router, prefix="/api", tags=["Power Rankings"])
app.include_router(matchup_recaps.router, prefix="/api", tags=["Matchup Recaps"])
app.include_router(newsletter.router, prefix="/api", tags=["Newsletter"])
app.include_router(roster_analysis.router, prefix="/api", tags=["Roster Analysis"])
